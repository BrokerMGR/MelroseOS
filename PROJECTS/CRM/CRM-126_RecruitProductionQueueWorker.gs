...
const MGR_RECRUIT_WORKER = Object.freeze({
  ...
  FIRST_NAME_HEADERS: Object.freeze([
    'firstname',
    'first',
    'givenname'
  ]),
  LAST_NAME_HEADERS: Object.freeze([
    'lastname',
    'last',
    'surname'
  ]),
  ...
  UNSUB_HEADERS: Object.freeze([
    'unsubscribed',
    'unsubscribe',
    'optout'
  ]),
  DNC_HEADERS: Object.freeze([
    'donotcontact',
    'dnc'
  ]),
  REPLIED_HEADERS: Object.freeze([
    'replied',
    'replyreceived'
  ])
});
...
function MGR_RECRUIT_updateState_(
  sheet,
  record,
  sequence,
  sentAt,
